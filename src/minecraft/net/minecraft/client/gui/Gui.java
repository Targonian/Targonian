...
public class Gui
{
    ...
    public void drawCenteredString(FontUtils font_Title, String text, int x, int y, int color)
    {
        font_Title.drawStringWithShadow(text, (float)(x - font_Title.getWidth(text) / 2), (float)y, color);
    }
    ...
    public void drawString(FontUtils fontRendererIn, String text, int x, int y, int color)
    {
        fontRendererIn.drawStringWithShadow(text, (float)x, (float)y, color);
    }
